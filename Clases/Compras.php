...
echo date_format($fecha, 'Y-m-d');
     ...
     function AgregarCompra($datos) {
        ...
        $retorno = array();
        $query = "INSERT INTO tbfactura(CEDULA_FK,ID_ARTICULO,NUMERO_FAC,FECHA_COM,CANTIDAD)";
        $query .= "VALUES('" . $datos["cedulafk"]. "',";
        $query .= "'" . $datos["codigo"] . "','" . $datos["numfac"] . "',";
    ...
    function CargarCompra($Num_Factura){
         require './BD/ConexionBD.php';
        $retorno = array();
        $query = "SELECT * FROM tbfactura WHERE NUMERO_FAC='" . $Num_Factura . "'";
        $resultado = $mysql->query($query);
