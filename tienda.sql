...
-- Tiempo de generación: 21-12-2019 a las 02:24:50
...
(9, 345, 'pedigree', 'Alimento', 7500, 6, 'S_royalcaninchnwetpuppyv011378.jpg');
...
INSERT INTO `tbfactura` (`ID_COMPRA`, `CEDULA_FK`, `ID_ARTICULO`, `NUMERO_FAC`, `FECHA_COM`, `CANTIDAD`) VALUES
(1, '123', 333, 1, '2019-12-12 00:00:00', 5),
(42, '11649', 987, 8, '2019-12-21 00:00:00', 2);
...
(6, '444', 'User', 'maxi', 'Brenes', 70692993, 'juanpabrenes85@gmail.com', 'maxibre', '1234');
COMMIT;
